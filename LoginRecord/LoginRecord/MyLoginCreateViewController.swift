//
//  MyLoginCreateViewController.swift
//  LoginRecord
//
...
class MyLoginCreateViewController: UIViewController, UITextFieldDelegate {
    ...
    @IBAction func buttonSave() {
        ...
        let urlString: String = "http://condi.swu.ac.kr/student/W11iphone/insertUser.php"
